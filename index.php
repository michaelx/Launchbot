...
<div id="wrapper">
	<div id="favbar"><?php foreach ($favbarsites as $url) {echo "<a href=\"http://".$url."\" target=\"_blank\"><img src=\"http://www.google.com/s2/favicons?domain=".$url."\"></a> ";} ?> &nbsp;</div>
	<div id="contentWrapper">
		<div id="content"> 
			<h1>&lt; Launchbot &gt;</h1>
			<div class="search">
				<p><img src="img/launchbot_eyes.png"></p>
			...
			for ($i = 0; $i < count($sets); $i++) {
    			...
    			echo "\"><img src=\"img/launchbot_sites.png\"><br /><br />".$sets[$i]["setname"]."</a>";
    			echo "</p>\n <p>";

				for ($u = 0; $u < count($sets[$i])-1; $u++) {
    				echo "<a href=\"http://".$sets[$i][$u]."\" target=\"_blank\"><img src=\"http://www.google.com/s2/favicons?domain=".$sets[$i][$u]."\"></a>\n ";
    			}
